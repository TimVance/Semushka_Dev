...
?>
<div class="bx-auth-reg registration-page-wrapper">
...
<input type="hidden" name="SIGNED_DATA" value="<?=htmlspecialcharsbx($arResult["SIGNED_DATA"])?>" />
            ...
            <label class="uk-form-label"><?echo GetMessage("main_register_sms")?></label><span class="starrequired">*</span>
...
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	<?else:?>
        <label class="uk-form-label"><?=GetMessage("REGISTER_FIELD_".$FIELD)?><?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><span class="starrequired">*</span><?endif?></label>
			<?
	switch ($FIELD)
	{
		case "PASSWORD":
			?><input size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="uk-input bx-auth-input " />
...
<?
		...
		case "CONFIRM_PASSWORD":
			?><input class="uk-input" size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" /><?
			break;
		...
		default:
			...
			?><input class="uk-input" size="30" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" /><?
...
?>
	<div class="uk-margin-medium">
        <input class="btn uk-width" type="submit" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" />
    </div>
</form>
