...
<?endforeach?>
    ...
    <label class="uk-margin">
            ...
            <div class="uk-form-controls">
                <input class="uk-input" type="text" name="USER_LOGIN" maxlength="50" value="" size="17" />
                <script>
                    BX.ready(function() {
    ...
    <div class="uk-margin">
            ...
            <div class="uk-form-controls">
                <input class="uk-input" type="password" name="USER_PASSWORD" maxlength="255" size="17" autocomplete="off" />
...
<?endif?>
    <div class="uk-margin-medium">
        <input class="btn uk-width" type="submit" name="Login" value="<?=GetMessage("AUTH_LOGIN_BUTTON")?>" />
    </div>
<?if($arResult["NEW_USER_REGISTRATION"] == "Y"):?>
    <noindex><div><a href="<?=$arResult["AUTH_REGISTER_URL"]?>" rel="nofollow"><?=GetMessage("AUTH_REGISTER")?></a></noindex></div>
<?endif?>
